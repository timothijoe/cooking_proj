...
接手开发请先读 [V1 完整设计与交接文档](../docs/agent/simulation/potato-regrasp-v1.md)，行为基线为 `4b1928e`。本页按倒序保留历次参数和结果；旧段落中的“当前”、旧命令与旧模型尺寸仅指当时版本，不能直接作为 V1 的运行配方。
