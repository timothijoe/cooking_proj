...
- 编年体：[双臂切菜形成](chronicles/2026-07-08-dual-arm-chopping.md)
- 决定：[本地大资源](decisions/001-local-assets.md)

- [土豆连续切菜倒手 V1：完整设计与开发交接](potato-regrasp-v1.md)：`4b1928e` 基线、动作控制、传感/RL 接口、问题处理、复现和验证证据
...
- [独立倒手 PPO 残差基线：输入、动作、奖励和训练](regrasp-rl-baseline.md)

- [九次退腕、三次移指：多样本播放与实现](regrasp-nine-demo.md)
